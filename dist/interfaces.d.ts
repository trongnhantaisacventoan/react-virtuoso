...
export interface TableComponents<Data = unknown, Context = unknown> {
     ...
     *
     */
    TableHead?: React.ComponentType<Pick<React.ComponentPropsWithRef<'thead'>, 'style' | 'ref'> & {
        context?: Context;
    }>;
    /**
     * Set to render a fixed footer at the bottom of the table (`tfoot`). use [[fixedFooterContent]] to set the contents
     */
    TableFoot?: React.ComponentType<Pick<React.ComponentPropsWithRef<'tfoot'>, 'style' | 'ref'> & {
        context?: Context;
    }>;
    /**
